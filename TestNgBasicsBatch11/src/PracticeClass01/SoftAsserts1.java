...
public class SoftAsserts1 {
    ...
    public void verifyAndValidateSoftAssertions() {
        //in order to use soft assert more than one time, we should create the object of it.
        ...
        System.out.println("I am still executing even after failing the test the test above");
        soft.assertAll(); // we should use this in the last line
